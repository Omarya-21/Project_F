...
export default function Dashboard() {
  return (
    <div className="pt-24 pb-20">
      <h1 className="text-4xl font-black mb-12 text-white border-l-4 border-blue-600 pl-4 uppercase italic tracking-tighter">Command Center</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-gray-900 border border-gray-800 rounded-3xl p-8">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-xl font-black uppercase tracking-widest italic">Operation logs</h2>
            ...
            {[1, 2, 3, 4, 5].map(i => (
              <div key={i} className="flex items-center justify-between p-4 bg-black rounded-xl border border-gray-800">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white">Order #842{i} - Dispatched</h4>
                    <p className="text-[10px] text-gray-500 uppercase font-mono">Status: Transit | Destination: Sector {i}</p>
                  </div>
                </div>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-3xl p-8 h-fit">
          <h2 className="text-xl font-black mb-8 uppercase tracking-widest italic">Sector Control</h2>
