...
export default function Register() {
  ...
  return (
    <div className="pt-32 flex justify-center px-4">
      ...
      >
        <h2 className="text-3xl font-black mb-6 text-white text-center italic">NEW SECTOR REGISTRATION</h2>
        ...
        <p className="mt-6 text-center text-gray-500 text-sm">
          Already verified? <Link to="/login" className="text-blue-500 hover:underline">Logon Sector</Link>
        </p>
      </motion.div>
    </div>
  );
